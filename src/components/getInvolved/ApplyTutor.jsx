...
const SubjectCard = ({ subject }) => {
    ...
    const handleApplyClick = () => {
        window.open("https://forms.gle/z364CwT8uw2JSHMQ7", '_blank');
    };
        ...
        >
            <Container maxWidth="lg">
                ...
                <Box sx={{ textAlign: 'center', mb: { xs: 6, sm: 8, md: 10 } }}>
                    ...
                    >
                        Share your knowledge, inspire young minds, and make a lasting impact in your community.
                ...
                {/* Why Join Our Team Section - IMPROVED */}
                <Box sx={{ mb: 8 }}>
                    <Typography
                        variant="h4"
                        component="h2"
                        ...
                        <Grid container spacing={4} justifyContent="center">
                            <Grid item xs={12} sm={6} md={4}>
                                ...
                                >
                                    ...
                                    >
                                        Work around your schedule with flexible tutoring sessions that fit your lifestyle and availability.
                                    </Typography>
                                </Paper>
                            </Grid>
